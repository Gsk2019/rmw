...
public class BaseService<T> implements IBaseService<T> {
	...
	public JSONObject getCode(String code, String data){
		JSONObject json = new JSONObject();
		json.put("code", code);
		json.put("data", data);
		return json;
	...
	public JSONObject getJson(RetCode retCode, Object result){
		JSONObject json = new JSONObject();
		json.put("ret", retCode.getKey());
		json.put("data", result);
		json.put("msg", retCode.getValue());
		return json;
	}

	public JSONObject getJson(RetCode retCode){
		return getJson(retCode, null);
	}
