...
public final class SystemUtils {
    ...
    public static String getUserAgment(HttpServletRequest request){
        String ip = getIpAddr(request);
//        String mac = getMacAddress(ip);
        String llq = getRequestBrowserInfo(request);
//        String hu = getHostName(ip);
        return Md5.getMd5((ip + llq ).replaceAll(" ", "").trim());
    }
