...
<html>
	<head>
		...
		<script src="<%=basePath%>web/userinfo/publish_user1.js" type="text/javascript" charset="utf-8"></script>
	</head>
	<body>
	...
	<div class="publish_purchase_message_bg">
		<div class="publish_purchase_message">
			<div class="title">
				<p>——————&emsp;&emsp;<span>编辑求购信息</span>&emsp;&emsp;——————</p>
			</div>
			<div class="form">
				<p class="path">当前位置：<a href="supply.html">求供应</a>&gt;<span>编辑求购信息</span></p>
				<form class="layui-form layui-form-pane" action="">
					...
					<table class="layui-table">
						...
						<tr>
							...
							<td>
								<div class="layui-input-inline">
									<input type="number" id="count" name="count" placeholder="请输入数量" lay-verify="required" autocomplete="off" class="layui-input">
								</div>
							</td>
							<th>价格<i>*</i></th>
							<td>
								<div class="layui-input-inline" style="width: 80px;">
									<input type="number" id="price" name="price" lay-verify="required" placeholder="￥" autocomplete="off" class="layui-input">
								</div>
								<div class="layui-inline">-</div>
								<div class="layui-input-inline" style="width: 80px;">
									<input type="text" name="endPrice" id="endPrice" lay-verify="required" placeholder="￥" autocomplete="off" class="layui-input">
								</div>
							</td>
						</tr>
						<tr>
