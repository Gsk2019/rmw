...
<head>
	...
	<script src="<%=basePath%>web/gstock/publishing_spot_information.js" type="text/javascript" charset="utf-8"></script>
...
<div class="publish_purchase_message_bg">
	<div class="publish_purchase_message">
		<div class="title">
			<p>——————&emsp;&emsp;<span>发布现货信息</span>&emsp;&emsp;——————</p>
		</div>
		<div class="form">
			<p class="path">当前位置：<a href="<%=basePath%>web/gstock/gstock.jsp">搜现货</a>&gt;<span>发布现货信息</span></p>
			<form class="layui-form layui-form-pane" action="">
				...
				<table class="layui-table">
					...
					<tr>
						...
						<td>
							<div class="layui-input-inline">
								<input type="text" readonly name="productDate" id="productDate" lay-verify="date_of_manufacture" placeholder="请选择生产日期" autocomplete="off" class="layui-input" lay-key="1">
							</div>(*选填)
						</td>
						<th>可供数量<i>*</i></th>
						<td>
					...
					<tr>
						...
						<td>
							<div class="layui-input-inline">
								<input type="number" name="price" placeholder="￥" lay-verify="required" autocomplete="off" class="layui-input">
							</div>
							<span>&nbsp;元/吨</span>
						</td>
						<th>有效期<i>*</i></th>
