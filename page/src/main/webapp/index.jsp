    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">${userMap.total1}</h1>
                    <div class="stat-percent font-bold text-success"><%--98% <i class="fa fa-bolt"></i>--%>
                    </div>
                    <small>(已认证：${userMap.total2})</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">${userMap.month1}</h1>
                    <div class="stat-percent font-bold text-navy"><%--44% <i class="fa fa-level-up"></i>--%>
                    </div>
                    <small>(已认证：${userMap.month2})</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">${userMap.day1}</h1>
                    <div class="stat-percent font-bold text-info"><%--20% <i class="fa fa-level-up"></i>--%>
                    </div>
                    <small>(已认证：${userMap.day2})</small>
                </div>
            </div>
        </div>
        <%--<div class="col-sm-3">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <table class="table table-hover no-margins">
                                ...
                                <tbody>
                                <c:forEach items="${xhList1 }" var="map">
                                <tr>
                                    <td><span class="label label-primary">${map.cname}</span></td>
                                    <td>${map.count}</td>
                                    <td><c:if test="${map.dun eq null}">0</c:if><c:if test="${map.dun != null}">${map.dun }</c:if></td>
                                </tr>
                                </c:forEach>
                                <tr>
                                    <td><span class="label label-del">总计</span></td>
                                    <td>${xhList1[0].sum }</td>
                                    <td><c:if test="${xhList1[0].sumDun eq null}" >0</c:if><c:if test="${xhList1[0].sumDun != null}" >${xhList1[0].sumDun }</c:if></td>
                                </tr>
                                <%--<tr>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <table class="table table-hover no-margins">
                                ...
                                <tbody>
                                <c:forEach items="${xhList2 }" var="map">
                                    <tr>
                                        <td><span class="label label-warning">${map.cname}</span></td>
                                        <td>${map.count}</td>
                                        <td><c:if test="${map.dun eq null}">0</c:if><c:if test="${map.dun != null}">${map.dun }</c:if></td>
                                    </tr>
                                </c:forEach>
                                <tr>
                                    <td><span class="label label-del">总计</span></td>
                                    <td>${xhList2[0].sum }</td>
                                    <td><c:if test="${xhList2[0].sumDun eq null}" >0</c:if><c:if test="${xhList2[0].sumDun != null}" >${xhList2[0].sumDun }</c:if></td>
                                </tr>
                                <%--<tr>
                                    <td><small>进行中...</small> </td>
                                    <td><i class="fa fa-clock-o"></i> 11:20</td>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <table class="table table-hover no-margins">
                                ...
                                <tbody>
                                <c:forEach items="${qgList1 }" var="map">
                                    <tr>
                                        <td><span class="label label-primary">${map.cname}</span></td>
                                        <td>${map.count}</td>
                                        <td><c:if test="${map.dun eq null}">0</c:if><c:if test="${map.dun != null}">${map.dun }</c:if></td>
                                ...
                                <tr>
                                    <td><span class="label label-del">总计</span></td>
                                    <td>${qgList1[0].sum }</td>
                                    <td><c:if test="${qgList1[0].sumDun eq null}" >0</c:if><c:if test="${qgList1[0].sumDun != null}" >${qgList1[0].sumDun }</c:if></td>
                                </tr>
                                <%--<tr>
                                    <td><small>进行中...</small></td>
                                    <td><i class="fa fa-clock-o"></i> 11:20</td>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <table class="table table-hover no-margins">
                                ...
                                <tbody>
                                <c:forEach items="${qgList2 }" var="map">
                                    <tr>
                                        <td><span class="label label-warning">${map.cname}</span></td>
                                        <td>${map.count}</td>
                                        <td><c:if test="${map.dun eq null}">0</c:if><c:if test="${map.dun != null}">${map.dun }</c:if></td>
                                ...
                                <tr>
                                    <td><span class="label label-del">总计</span></td>
                                    <td>${qgList2[0].sum }</td>
                                    <td><c:if test="${qgList2[0].sumDun eq null}" >0</c:if><c:if test="${qgList2[0].sumDun != null}" >${qgList2[0].sumDun }</c:if></td>
                                </tr>
                                <%--<tr>
                                    <td><small>进行中...</small> </td>
                                    <td><i class="fa fa-clock-o"></i> 11:20</td>
