            ...
            <form class="form-horizontal" id="addUserForm" method="POST" onsubmit="return false;">
                ...
                <div class="form-group col-sm-12">
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-10">
                            <input id="name" name="name" readonly value="${rmwRepertory.name}" class="form-control" placeholder="请输入仓库交割地址" validate="{required:true,maxlength:20}" validateMessage="{required:'请输入仓库交割地址',maxlength:'输入的仓库交割地址超出长度限制'}" >
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-sm-12">
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-10">
                            <input id="sort" sort="name" readonly value="${rmwRepertory.sort}"  >
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-sm-12">
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-10">
                            <textarea id="addr" name="addr" readonly  placeholder="请输入详细地址" class="form-control" validate="{required:true,maxlength:50}" validateMessage="{required:'请输入详细地址',maxlength:'输入的详细地址超出长度限制'}" >${rmwRepertory.addr}</textarea>
                        </div>
                    </div>
                </div>
