            ...
            <form class="form-horizontal" id="addUserForm" method="POST" onsubmit="return false;">
                ...
                <div class="form-group col-sm-12">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <input id="title" name="title" readonly value="${news.title}" class="form-control" validate="{required:true,maxlength:50}" validateMessage="{required:'请输入名称',maxlength:'输入的名称超出长度限制'}" >
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <input id="publisher" name="publisher" readonly value="${news.publisher}" class="form-control" validate="{required:true,maxlength:50}" validateMessage="{required:'请输入名称',maxlength:'输入的名称超出长度限制'}" >
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <input id="weight" name="weight" readonly value="${news.weight}" oninput='this.value=this.value.replace(/^[0]+[0-9]*$/gi,"")' onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" placeholder="请输入数字，从小到大排序" class="form-control" validate="{required:true,min:0,maxlength:8}" validateMessage="{required:'请输入权重，内容为数字',maxlength:'输入的权重超出长度限制'}" >
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-10">
                            <textarea id="summary" name="summary" readonly  placeholder="请输入摘要" class="form-control" validate="{required:true,min:0,maxlength:40}" validateMessage="{required:'请输入摘要',maxlength:'输入的摘要超出长度限制'}" >${news.summary}</textarea>
                        </div>
                    </div>
                </div>
