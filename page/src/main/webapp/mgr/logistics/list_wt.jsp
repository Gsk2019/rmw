...
<div class="wrapper wrapper-content animated fadeInUp">
    <div class="row row-lg">
        ...
        <div class="col-sm-12">
            ...
            <cs:toolbar title="物流" tableId="tab_user" width="70%" height="70%" menuCode="${menuCode }" type="1">
            ...
            >
                ...
                <tr>
                    ...
                    <th data-field="linkMan">委托人</th>
                    <th data-field="phone" >联系方式</th>
                    <th data-field="startPoint" >起点</th>
                    <th data-field="endPoint" >终点</th>
                    <th data-field="consignment" >委托货物</th>
                    <th data-field="tonnage" >委托吨位</th>
                    <th data-field="status" data-formatter="getStatus">状态</th>
                    <th data-field="createDate" data-formatter="format_time">委托时间</th>
