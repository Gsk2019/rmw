    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" action="check.cs" id="addLogisticsForm" method="POST" onsubmit="return false;">
                <input type="hidden" value="${logistics.id }" name="id"/>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <label class="radio-inline"  >
                                <input type="radio"  value="2" name="status" <c:if test="${logistics.status eq 2}">checked</c:if>>通过
                            </label>
                            <label class="radio-inline" >
                                <input type="radio"  value="3" name="status" <c:if test="${logistics.status eq 3}">checked</c:if>>不通过
                            </label>
                        </div>
                    </div>
                </div>
