            ...
            <form class="form-horizontal" id="editMenuForm" action="edit.cs" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input id="categoryName" name="categoryName" value="${category.categoryName }" class="form-control" validate="{required:true, minlength:1}" validateMessage="{required:'请输入品类名称'}"  >
                    </div>
                </div>
