...
<head>
	...
	<link rel="stylesheet" href="<%=basePath%>res/js/plugins/ztree/demo.css" type="text/css">
	<link rel="stylesheet" href="<%=basePath%>res/js/plugins/ztree/metroStyle/metroStyle.css" type="text/css">
	<script type="text/javascript" src="<%=basePath%>res/js/plugins/ztree/jquery.ztree.core.js"></script>
	<script type="text/javascript" src="<%=basePath%>res/js/plugins/ztree/jquery.ztree.excheck.js"></script>
	<script type="text/javascript" src="<%=basePath%>res/js/plugins/ztree/jquery.ztree.exedit.js"></script>
...
<%-- 						</p:permission> --%>
					...
					<ul id="treeMenu" class="ztree" style="width:100%;"></ul>
			</div>
