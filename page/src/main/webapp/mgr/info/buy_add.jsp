...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" action="addBuy.cs" id="addUserForm" method="POST" onsubmit="return false;">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="form-group col-sm-12">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <input id="count" name="count" class="form-control" oninput='this.value=this.value.replace(/^[0]+[0-9]*$/gi,"")' onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" validate="{required:true}" validateMessage="{required:'请输入数量'}" placeholder="请输入求购数量，单位：吨">
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            <label class="col-sm-4 control-label">求购价格：</label>
                            <div class="col-sm-8">
                                <input id="price" name="price" class="form-control" style="width: 47%;float:left" oninput='this.value=this.value.replace(/^[0]+[0-9]*$/gi,"")' onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" validate="{required:true}" validateMessage="{required:'请输入价格'}" placeholder="最低价"  ><span style="float: left">--</span> <input id="endPrice" name="endPrice" class="form-control" style="width: 47%;float:left" oninput='this.value=this.value.replace(/^[0]+[0-9]*$/gi,"")' onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" validate="{required:true}" validateMessage="{required:'请输入价格'}" placeholder="最高价"  >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <input id="expiryDate" name="expiryDate"  readonly class="form-control" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" validate="{required:true}" validateMessage="{required:'请输入有效期'}" placeholder="请输入信息有效期"  >
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-12">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <input id="note" name="note" value="" class="form-control" placeholder="请输入备注" validate="{required:true,maxlength:255}" validateMessage="{required:'请输入备注',maxlength:'输入内容超出长度限制'}" >
                            </div>
                        </div>
                    </div>
