...
<head>
    ...
    <script>
        ...
        //获取分类
        function getCategory2(value,row,index){
            return  row.categoryTopName+"-"+row.categoryName;
        }
        //获取状态
        ...
        <div class="col-sm-12">
            ...
            >
                ...
                <tr>
                    ...
                    <th data-field="contact_name">供货人</th>
                    <th data-field="contact_tel" >供货人电话</th>
                    <th data-field="" data-formatter="getCategory">供货品类</th>
                    <th data-field="price" >供货价格</th>
                    <th data-field="count" >供货数量</th>
                    <th data-field="create_date" data-formatter="format_time">供货时间</th>
                    <th data-field="contactName" >求购人</th>
                    <th data-field="status" data-formatter="getStatus">状态</th>
                    <th data-field="contactTel" >求购人电话</th>
                    <th data-field="" data-formatter="getCategory2">求购品类</th>
                    <th data-field="price2" >求购价格</th>
                    <th data-field="count2" >求购数量</th>
                    <th data-field="trader_name" >交易员</th>
                    <th data-field="trader_phone" >交易员电话</th>
                    <th data-field="createDate" data-formatter="format_time">求购时间</th>
                </tr>
                </thead>
            </table>
        </div>
