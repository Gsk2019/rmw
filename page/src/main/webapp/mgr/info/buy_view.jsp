            ...
            <form class="form-horizontal" id="addUserForm" method="POST" onsubmit="return false;">
                ...
                <div class="form-group col-sm-12">
                    <div class="form-group col-sm-6">
                        ...
                        <label class="col-sm-4 control-label" style="text-align: left;font-weight:normal">${info.price}--${info.endPrice}元</label>
                    </div>
                    <%--<div class="form-group col-sm-6">--%>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="form-group col-sm-6">
                        <label class="col-sm-4 control-label">信息有效期：</label>
                        <label class="col-sm-4 control-label" style="text-align: left;font-weight:normal">${info.expiryDate}</label>
                    </div>
                </div>
