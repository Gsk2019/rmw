...
<head>
	...
	<script src="res/js/content.js" type="text/javascript"></script>
		                        ...
		                        <ul class="nav nav-second-level">
		                        		<c:forEach items="${permissions }" var="p2">
		                        			<c:if test="${p2.pid == p.menu_id}">
		                        				<li>  <a class="J_menuItem" href="${p2.url}?menuCode=${p2.menu_code}" code="${p2.menu_code }" >${p2.menu_name }</a> </li>
		                        			</c:if>
		                        		</c:forEach>
		                        </ul>
		                       </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="javascript:return false;"><i class="fa fa-bars"></i> </a>
...
<!--                         </li> -->
            ...
            <div class="footer">
                <%--<div class="pull-middle">&copy; 2018-2020 <a href="#" target="_blank">zihan's blog</a>--%>
