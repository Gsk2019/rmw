...
<!--                       </div> -->
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-6">
                              <input id="name" name="name" class="form-control" validate="{required:true}" value="${user.name }" validateMessage="{required:'请输入名称'}" >
                          </div>
                      </div>
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-6">
                              <input id="account" name="account" class="form-control" readonly="readonly"  validate="{required:true}" value="${user.account }"  validateMessage="{required:'请输入账号'}" >
                          </div>
                      </div>
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-6">
                              <input id="pwd" name="pwd" class="form-control"  value="" validateMessage="{required:'请输入密码'}" >
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-6">
                              <input id="phone" name="phone" value="${user.phone}" class="form-control" validate="{required:true}" validateMessage="{required:'请输入手机号码'}" >
                          </div>
                      </div>
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-6">
                              <cs:file name="img" type="100" url="${user.img }" desc="${user.img }"></cs:file>
                          </div>
                      </div>
